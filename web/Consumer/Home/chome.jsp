...
<html>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
        <img class="d-block w-100" src="../../img/ankit-patel-NqtjrfAOjPw-unsplash.jpg" alt="First slide">
    ...
    <div class="carousel-item">
        <img class="d-block w-100" src="../../img/kin-li-P_HBwB8N9ag-unsplash.jpg" alt="Second slide">
         <div class="carousel-caption d-none d-md-block">
   ...
   <p><form action="Consumer/Registration/registration.html" method="post">
    ...
    <div class="carousel-item">
        <img class="d-block w-100" src="../../img/olivier-collet-QRL56Jr6Va4-unsplash.jpg" alt="Third slide">
        <div class="carousel-caption d-none d-md-block">
